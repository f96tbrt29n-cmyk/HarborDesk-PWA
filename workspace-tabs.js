...
const HD_WS_EXPLICIT={
 ...
 arsenal:new Set(['equipmentBook','equipmentVariants','developmentLab','developmentRecipes','constructionDb','improvementWorkshop','optimizationImprovement','materialPlanner']),
