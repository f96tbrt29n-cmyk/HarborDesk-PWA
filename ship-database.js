...
function hdRenderShipDatabase(){
 ...
 const count=document.getElementById('hdShipDbCount');if(count)count.textContent=q&&hdShipDbIncludeMaster?`詳細 ${rows.length} / マスター ${masterRows.length}`:`詳細 ${rows.length}隻`;
