...
window.addEventListener('hd:ship-images-changed',()=>{if(typeof hdShipImageHydrate==='function')hdShipImageHydrate(document.getElementById('hdShipDbList')||document)});
