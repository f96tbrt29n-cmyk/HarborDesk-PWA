const CACHE='harbordesk-pwa-v17';
const ASSETS=['./styles.css','./map-details.css','./map-plans.css','./custom-fleets.css','./ship-roster.css','./advanced-tools.css','./home-dashboard.css','./map-tabs.css','./map-images.css','./update-manager.css','./app.js','./map-details.js','./map-details-34.js','./map-details-57.js','./map-plans.js','./ship-roster.js','./custom-fleets.js','./map-images.js','./map-tabs.js','./advanced-tools.js','./home-dashboard.js','./update-manager.js','./app-version.json','./manifest.webmanifest'];
