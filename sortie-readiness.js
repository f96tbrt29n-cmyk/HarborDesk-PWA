...
function hdSortieMinePane(){
 const fallback=document.getElementById('hdFallbackMineTools'),normal=document.querySelector('[data-map-pane="mine"]:not(#hdFallbackMineTools)');
 if(fallback&&!document.querySelector('[data-map-tab="mine"]'))return fallback;
