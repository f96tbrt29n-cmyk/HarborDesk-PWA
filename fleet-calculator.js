...
function hdFCMutate(map,fleetId,fn){const s=hdFCState(map,fleetId);fn(s);hdFCSaveState(map,fleetId,s);hdFCScheduleRender()}
...
function hdFCReset(map,fleetId){const all=hdFCLoadAll(),key=hdFCMapKey(map,fleetId);all[key]=hdFCDefaultState(map,fleetId);hdFCSaveAll(all);hdFCScheduleRender()}
